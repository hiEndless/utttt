...
# 创建带有标签的路由
router = APIRouter(tags=["Dashboard - Positions"])
...
@router.get("/dashboard/positions", response_model=BaseResponse[List[PositionResponse]])
...
@router.get("/dashboard/positions/{exchange}", response_model=BaseResponse[PositionResponse])
