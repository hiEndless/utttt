...
_SOURCE_CATEGORY_ALIASES = {
    ...
    "market_large_liquidation": "liquidation",
    "liquidation_event": "liquidation",
    "forced_liquidation": "liquidation",
    "macro_news": "macro",
    "social_media": "social",
    "social_news": "social",
    "social_news_event": "social",
    "headline_news": "news",
}
...
_DEFAULT_ROUTER_CONFIG = {
    ...
    "event_type_aliases": {
        ...
        "market_indicator_event_signal": "market_indicator_signal",
        ...
        "chain_wallet_anomaly": "onchain_wallet_anomaly",
        "onchain_wallet_anomaly_event": "onchain_wallet_anomaly",
        ...
        "market_large_liquidation": "large_liquidation",
        "large_liquidation_event": "large_liquidation",
        ...
        "social_media_hot_news": "social_news",
        "social_news_event": "social_news",
