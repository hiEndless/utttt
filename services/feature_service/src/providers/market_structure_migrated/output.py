...
from services.feature_service.src.providers.market_structure_migrated.horizons.output import build_output as build_horizons_output
from services.feature_service.src.providers.market_structure_migrated.open_interest.output import build_output as build_open_interest_output
from services.feature_service.src.providers.market_structure_migrated.orderbook.output import build_output as build_orderbook_output
...
async def build_output(
    ...
    await client.set(key, json.dumps(value_to_store, ensure_ascii=False))
