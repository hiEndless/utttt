...
- `decision_trace_routing_contract_version: agent-decision-trace-routing-v8`
...
- `services/agent_server_new/docs/llm_signal_decision.schema.json`
...
- `execution_schema_mapping_version: execution-schema-mapping-v22`
...
- `decision_prompt_config_fields: risk_hints.prompt_config_source/prompt_config_version`（可选：非空字符串，用于追踪 agent 决策提示词配置来源与版本）
