...
| TradeEventExpert | Qwen/Qwen3-VL-235B-A22B-Instruct | 交易事件分析 | 交易详情、市场结构 | 交易分析结果 | `agent_server/agents/experts/analysis/trade_event.py` |
...
- **事件分析 Expert**：信号验证、交易事件分析、持仓风控、爆仓分析、新闻分析、技术分析、投资组合分析
