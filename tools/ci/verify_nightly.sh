...
echo "[nightly] MIN_SIGNAL_DECISION_GLOBAL_DECISION_MODE_LLM_RATIO=$MIN_SIGNAL_DECISION_GLOBAL_DECISION_MODE_LLM_RATIO MIN_SIGNAL_DECISION_GLOBAL_LLM_OK_RATIO=$MIN_SIGNAL_DECISION_GLOBAL_LLM_OK_RATIO"
