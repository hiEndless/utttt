...
WITH_AGENT_ACTION_HINT_CASES_REPORT="${WITH_AGENT_ACTION_HINT_CASES_REPORT:-0}"
...
echo "[regression] WITH_AGENT_ACTION_HINT_CASES_REPORT=$WITH_AGENT_ACTION_HINT_CASES_REPORT AGENT_ACTION_HINT_CASES_REPORT_PATH=$AGENT_ACTION_HINT_CASES_REPORT_PATH"
REGRESSION_ARGS=(
