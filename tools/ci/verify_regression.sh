...
echo "[regression] WITH_AGENT_SIGNAL_ROUTER_BASELINE_REPLAY=$WITH_AGENT_SIGNAL_ROUTER_BASELINE_REPLAY AGENT_SIGNAL_ROUTER_BASELINE_REPLAY_SAMPLES_PATH=$AGENT_SIGNAL_ROUTER_BASELINE_REPLAY_SAMPLES_PATH AGENT_SIGNAL_ROUTER_BASELINE_REPLAY_REPORT_PATH=$AGENT_SIGNAL_ROUTER_BASELINE_REPLAY_REPORT_PATH AGENT_SIGNAL_ROUTER_BASELINE_REPLAY_STRICT=$AGENT_SIGNAL_ROUTER_BASELINE_REPLAY_STRICT"
...
echo "[regression] MIN_SIGNAL_DECISION_SOURCE_QUALITY_MIN_SOURCE_COUNT=$MIN_SIGNAL_DECISION_SOURCE_QUALITY_MIN_SOURCE_COUNT MIN_MARKET_INDICATOR_LLM_OK_RATIO=$MIN_MARKET_INDICATOR_LLM_OK_RATIO MIN_ONCHAIN_WALLET_LLM_OK_RATIO=$MIN_ONCHAIN_WALLET_LLM_OK_RATIO MIN_LARGE_LIQUIDATION_LLM_OK_RATIO=$MIN_LARGE_LIQUIDATION_LLM_OK_RATIO MIN_SOCIAL_NEWS_LLM_OK_RATIO=$MIN_SOCIAL_NEWS_LLM_OK_RATIO"
echo "[regression] MIN_SIGNAL_DECISION_GLOBAL_DECISION_MODE_LLM_RATIO=$MIN_SIGNAL_DECISION_GLOBAL_DECISION_MODE_LLM_RATIO MIN_SIGNAL_DECISION_GLOBAL_LLM_OK_RATIO=$MIN_SIGNAL_DECISION_GLOBAL_LLM_OK_RATIO"
...
if [[ "$WITH_AGENT_SIGNAL_ROUTER_BASELINE_REPLAY" == "1" ]]; then
  ...
  echo "[regression] signal_router_baseline_replay_report_path=$AGENT_SIGNAL_ROUTER_BASELINE_REPLAY_REPORT_PATH"
fi
...
bash tools/local/print_signal_decision_llm_observe_aggregate_summary.sh --summary "$SUMMARY_PATH" --prefix regression
