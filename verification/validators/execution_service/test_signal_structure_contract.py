...
def test_scope_and_position_required_fields_frozen() -> None:
    scope_schema = _load_schema("execution_service/docs/signal_scope.schema.json")
    before_schema = _load_schema("execution_service/docs/position_before.schema.json")
    after_schema = _load_schema("execution_service/docs/position_after_simulation.schema.json")
