...
if __package__:
    from feature_service.providers.market_structure_migrated.utils.redis_client import get_verified_redis_client
    ...
    from feature_service.providers.market_structure_migrated.utils.redis_client import get_verified_redis_client
    from feature_service.providers.market_structure_migrated.io.background_kline import read_multi_period
    from feature_service.providers.market_structure_migrated.io.raw_reader import PERIODS, read_market_raw
    from feature_service.providers.market_structure_migrated.horizons.build_context import (
